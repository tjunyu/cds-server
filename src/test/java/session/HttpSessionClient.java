...
/**
 * This class is meant to be run against {@link }.
 */
public class HttpSessionClient {

    private static final Logger logger = Logger.getLogger(HttpSessionClient.class.getName());

    private final String baseUri;
    private final String filePath;

    public HttpSessionClient(String baseUri, String filePath) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new HttpSessionClient(baseUri, filePath).run();
    }
